...
function boundsCheck(object)
    ...
    elseif object.Data.position.x > ControllableObjects[1].Data.size.width - object.Data.size.width then
        object.Data.position.x = ControllableObjects[1].Data.size.width - object.Data.size.width
        object.Data.direction.x = 0
    end
    if object.Data.position.y < 0 then
        object.Data.position.y = 0
        object.Data.direction.y = 0
    elseif object.Data.position.y > ControllableObjects[1].Data.size.height - object.Data.size.height then
        object.Data.position.y = ControllableObjects[1].Data.size.height - object.Data.size.height
        object.Data.direction.y = 0
    end
    if object.reference == "enemies" then
        return
    end
...
function love.load()
    ...
    addMovingObject("enemy01", "Enemy#1", "enemy", "fill", {
        position = {
            x = math.random(0, StaticObjects[1].Data.size.width - 20 / 2),
            y = math.random(0, StaticObjects[1].Data.size.height - 20 / 2)
        },
        size = {
            width = 20 / 2,
            height = 20 / 2
